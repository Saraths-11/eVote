                            ...
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr style="border-bottom: 1px solid #f3f4f6;">
                                    ...
                                    <td style="padding: 0.75rem; display: flex; gap: 1rem;">
                                        ...
                                        <?php if ($row['status'] !== 'Closed' && $row['voting_status'] === 'ended'): ?>
                                            <a href="update_status.php?id=<?php echo $row['id']; ?>&type=close&value=1"
                                                style="color: #ef4444; font-size: 0.85rem; text-decoration: none; font-weight: 600;"
                                                onclick="return confirm('Permanently close this election?')">Close</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
        ...
        <div class="grid-cards">
            <div class="card">
                ...
                <div style="margin-top: 1.5rem;">
                    <?php if ($can_create_election): ?>
                        <a href="create_election.php" class="btn btn-primary"
                            style="padding: 0.6rem 1.25rem; font-size: 0.9rem;">Create New</a>
                    <?php else: ?>
                        <button class="btn btn-secondary" disabled
                            style="padding: 0.6rem 1.25rem; font-size: 0.9rem; cursor: not-allowed; opacity: 0.6;"
                            title="Close the current election to create a new one">Create New (Disabled)</button>
                    <?php endif; ?>
            ...
            <div class="card">
                ...
                <div style="margin-top: 1.5rem; display: flex; flex-direction: column; gap: 0.75rem;">
                    ...
                    <a href="view_participants.php?view=Cancelled" 
                        style="font-size: 0.85rem; color: #ef4444; text-decoration: none; font-weight: 700; display: flex; align-items: center; justify-content: center; gap: 0.4rem; padding: 0.6rem; border: 1px dashed #fecaca; border-radius: 8px; background: #fef2f2;">
