...
async function runNominationTest() {
    ...
    try {
        ...
        // 3. NAVIGATE TO NOMINATION (Assuming ID 1 for test purposes, or dynamically finding the link)
