...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($email === 'sarath123@gmail.com' && $password === '2004') {
            $_SESSION['user_id'] = 0; // specific ID for admin
            ...
            // Since we removed the SQL check, any non-admin POST request that reaches here 
            // means Firebase login failed or was bypassed, and it's not the hardcoded admin.
    ...
    <script type="module">
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                // Allow Hardcoded Admin to fall back to PHP
